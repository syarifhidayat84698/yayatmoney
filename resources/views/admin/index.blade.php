                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="dashboard">ICO dashboard</a></li>
                                    <li><a href="ecommerce-dashboard">Ecommerce dashboard</a></li>
                                    <li><a href="ico-dashboard">SEO dashboard</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout-sidebar-left"></i><span>Pencatatan Transaksi</span></a>
                                <ul class="collapse">
                                    <li><a href="/pendapatan">Tambah Pemasukan</a></li>
                                    <li><a href="index3-horizontalmenu.html">Tambah Pengeluaran</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-pie-chart"></i><span>Manajemen Hutang/Piutang</span></a>
                                <ul class="collapse">
                                    <li class="active"><a href="bar">Tambah Hutang</a></li>
                                    <li><a href="line">Tambah Piutang</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-pie-chart"></i><span>Laporan Keuangan</span></a>
                                <ul class="collapse">
                                    <li class="active"><a href="bar">Lihat Laporan</a></li>
                                    <li><a href="line">Grafik Tren Keuangan</a></li>
                                    <li><a href="pie">Ekspor Laporan</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-palette"></i><span>Pengingat Pembayaran</span></a>
                                <ul class="collapse">
                                    <li><a href="accordion.html">Tambah Pengingat Baru</a></li>
                                    <li><a href="alert.html">Notifikasi Pembayaran Jatuh Tempo</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-slice"></i><span>Fitur Tambahan</span></a>
                                <ul class="collapse">
                                    <li><a href="fontawesome.html">Saran Keuangan Berbasis AI</a></li>
                                    <li><a href="themify.html">Integrasi Pembayaran Digital</a></li>
                                    <li><a href="themify.html">Pengelompokan Otomatis</a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
